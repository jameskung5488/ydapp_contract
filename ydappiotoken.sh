...
# cleos -u http://api.eosbeijing.one push action eosio.token transfer '[ "ydappiotoken", "biquanlaomao", "0.0002 EOS" "Thank you for test ydappiotoken. Have a nice day!"]' -p ydappiotoken@active
