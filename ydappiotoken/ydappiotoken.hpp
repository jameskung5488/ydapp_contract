...
class ydappiotoken : public contract {
    public: ydappiotoken(account_name self) :
        contract(self),
        _global(_self, _self){}
...
void ydappiotoken::apply(account_name code, action_name action) {   
    ...
    switch (action) {
        EOSIO_API(ydappiotoken, (init)(clear));
    };
}
